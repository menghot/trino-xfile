...
public class XFileModule
    ...
    public void configure(Binder binder) {
        ...
        binder.bind(XFileMetadataClient.class).to(XFileMetadataClientFileStoreImpl.class).in(Scopes.SINGLETON);
        binder.bind(XFileSplitManager.class).in(Scopes.SINGLETON);
        configBinder(binder).bindConfig(XFileConfig.class);
        jsonCodecBinder(binder).bindJsonCodec(XFileCatalog.class);
    }
}
