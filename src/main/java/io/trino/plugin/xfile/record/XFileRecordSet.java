...
public class XFileRecordSet
        implements RecordSet {
    private final List<XFileColumnHandle> columnHandles;
    private final List<Type> columnTypes;
    private final XFileSplit split;
    private final TrinoFileSystem trinoFileSystem;

    public XFileRecordSet(XFileSplit split, List<XFileColumnHandle> columnHandles, TrinoFileSystem trinoFileSystem) {
        requireNonNull(split, "split is null");
        this.split = split;
        this.trinoFileSystem = trinoFileSystem;
        this.columnHandles = requireNonNull(columnHandles, "columnHandles is null");
        ImmutableList.Builder<Type> types = ImmutableList.builder();
        for (XFileColumnHandle column : columnHandles) {
