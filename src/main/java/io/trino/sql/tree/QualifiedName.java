...
public class QualifiedName {
    ...
    public static QualifiedName of(String first, String... rest) {
        ...
        return of((Iterable)Lists.asList(first, rest).stream().map(Identifier::new).collect(ImmutableList.toImmutableList()));
    }

    public static QualifiedName of(String name) {
        Objects.requireNonNull(name, "name is null");
        return of((Iterable)ImmutableList.of(new Identifier(name)));
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return o != null && this.getClass() == o.getClass() ? this.parts.equals(((QualifiedName)o).parts) : false;
        }
    }
