...
public final class XFileMetadataUtil {
    private XFileMetadataUtil() {
    }

    public static final JsonCodec<Map<String, List<XFileTable>>> CATALOG_CODEC;
    public static final JsonCodec<XFileTable> TABLE_CODEC;
    public static final JsonCodec<XFileColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(XFileTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(XFileTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(XFileColumnHandle.class);
    }
